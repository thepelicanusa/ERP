...
Index("ix_sec_user_role_user_role", SecUserRole.username, SecUserRole.role, unique=True)
...
# Back-compat alias (ORM class name is SecUserRole to avoid registry collisions)
UserRole = SecUserRole
